			...
			if (f.type !== 'signal') {
				...
				if (f.type === 'alert') {
					...
					if (f.params.button_1) {
						buttons += '<button class="quiz-button" id="'+f.type+'-ok1-'+f.newid+'">'+f.params.button_1+'</button>';
					}
					if (f.params.button_2) {
						buttons += '<button class="quiz-button" id="'+f.type+'-ok2-'+f.newid+'">'+f.params.button_2+'</button>';
					}
					if (f.params.button_3) {
						buttons += '<button class="quiz-button" id="'+f.type+'-ok3-'+f.newid+'">'+f.params.button_3+'</button>';
					}
